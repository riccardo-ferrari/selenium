 ...
 */
public class LiferayCityGartnerClickpath7 extends BaseLiferayCityGartnerClickpath {

	public LiferayCityGartnerClickpath7(
	...
	public void run(String username, String password) {
		...
		if (getChance(0.7)) {
			...
			if (getChance(0.2)) {
				doClickText("NEWS");
				sleep(1000);
				doClickRandomText(NEWS_LINKS_TEXTS_ELDER);
			}
		}
